...
import com.solidstategroup.diagnosisview.model.CustomField;
 ...
 */
public class CustomFieldArrayType implements UserType {
    ...
    public final Serializable disassemble(final Object value) throws HibernateException {
        return (CustomField[]) this.deepCopy(value);
    }
    ...
    public final Object nullSafeGet(final ResultSet resultSet, final String[] names, final SessionImplementor session,
        ...
        try {
            ...
            if (json != null) {
                return OBJECT_MAPPER.readValue(json, new TypeReference<List<CustomField>>() { });
            }
            return null;
        } catch (IOException e) {
    ...
    @Override
    public final Class<CustomField[]> returnedClass() {
